...
public class BluetoothLeService extends Service {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            ...
            broadcastUpdate(ACTION_GATT_CHARACTERISTIC_WRITE, characteristic, status);
        }


        @Override
        public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            broadcastUpdate(ACTION_GATT_CHARACTERISTIC_READ, characteristic, status);
        }
        ...
        public void onReadRemoteRssi(BluetoothGatt gatt, int rssi, int status) {
            broadcastUpdate(ACTION_GATT_READ_RSSI, rssi, status);
        }
    ...
    private void broadcastUpdate(final String action, final int rssI, int status) {
        final Intent intent = new Intent(action);
